   <span class="hamburger_menu_buttonu icon icon-menu"></span>
   <div class="hamburgerblackarea"></div>
  
   <div class="hamburgerMenuArea">
        <div class="hUserInf">
            <div class="userInfTextArea">
                <span style="font-size: 18px;">Hoşgeldiniz! </span> <br>
                <span style="font-size: 18px; text-transform: uppercase;"> Ad soyad</span><br>
